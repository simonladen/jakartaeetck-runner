...
tar zcf $report $WORKSPACE/mail-tck/JTreport/ $WORKSPACE/mail-tck/JTreport-Pluggability/ $WORKSPACE/results $SCRIPTPATH/payara6/glassfish/domains/domain1/logs